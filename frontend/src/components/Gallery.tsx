...
const rpcUrl = "http://127.0.0.1:8545/"; // Use this for local Hardhat testing
        ...
        for (let i = 0; i < totalSupply; i++) {
          ...
          if (listing.price > 0) {
            ...
            if (tokenURI.startsWith("data:application/json")) {
                ...
                // For production, you might want to replace "gateway.pinata.cloud" with a faster, dedicated gateway
            ...
            fetchedArtworks.push({
              id: i.toString(),
              title: metadata.title || metadata.name || "Untitled Artwork",
      ...
      <div className="container mx-auto px-6 relative">
        ...
        {isLoading ? (
          ...
          <div className="text-center py-24">
            ...
            <p className="text-zinc-400">Adjust your search criteria or check back later for new listings.</p>
          </div>
        ) : (
